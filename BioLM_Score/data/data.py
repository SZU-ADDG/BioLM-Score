...
class PDBbindDataset(Dataset):
	def __init__(self,
		...
		assert len(self.pdbids) == self.gls.num_graphs == self.gps.num_graphs == len(self.protein_embs)
	...
	def get(self, idx):
		...
		return pdbid, gp, gl, prot_emb, label
...
class VSDataset(Dataset):
	...
	def get(self, idx):
		...
		return id, gp, gl,protein_emb, label
