...
class ResidueAnnotationsTokenizer(EsmTokenizerBase):
    def __init__(self, csv_path = None, max_annotations: int = 16):
        if csv_path is None:
    ...
    def _description2id(self, description: str) -> Optional[int]:
    ...
    def tokenize(
        self, sample, sequence: str, fail_on_mismatch: bool = False
    ) -> list[str]:
        """
