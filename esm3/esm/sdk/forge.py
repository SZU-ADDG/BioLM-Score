...
from typing import List, Optional  # 或者 Union

def _list_to_function_annotations(l) -> Optional[List[FunctionAnnotation]]:
...
class SequenceStructureForgeInferenceClient:
    ...
    def fold(
        ...
        model_name = None,
    ) -> Union[ESMProtein, ESMProteinError]:
...
class ESM3ForgeInferenceClient(ESM3InferenceClient):
    ...
    def forward_and_sample(
    ...
    ) -> Union[ForwardAndSampleOutput, ESMProteinError]:
        ...
        def do_track(t: str):
            track: Optional[SamplingTrackConfig]
    ...
    @retry_decorator
    def encode(self, input: ESMProtein) -> Union[ESMProteinTensor, ESMProteinError]:
        tracks = {}
    ...
    @retry_decorator
    def decode(self, input: ESMProteinTensor) -> Union[ESMProtein, ESMProteinError]:
        _validate_protein_tensor_input(input)
    ...
    ) -> Union[LogitsOutput, ESMProteinError]:
        _validate_protein_tensor_input(input)
